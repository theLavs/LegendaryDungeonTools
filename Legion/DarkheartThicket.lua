...
local pi = math.pi
LDT.dungeonTotalCount[dungeonIndex] = {normal=280,teeming=336,teemingEnabled=true}
LDT.dungeonBosses[dungeonIndex] = {--Darkheart Thicket
	[1] = {
		[1] = {
...
LDT.dungeonEnemies[dungeonIndex] = { --Darkheart Thicket
	[1] = {
