...
local pi = math.pi
LDT.dungeonTotalCount[dungeonIndex] = {normal=206,teeming=242,teemingEnabled=true}
LDT.dungeonBosses[dungeonIndex] = {--Eye of Azshara
	[1] = {
		[1] = {
...
LDT.dungeonEnemies[dungeonIndex] = { --Eye of Azshara
	[1] = {
