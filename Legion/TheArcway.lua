...
local pi = math.pi
LDT.dungeonTotalCount[dungeonIndex] = {normal=392,teeming=466,teemingEnabled=true}
LDT.dungeonBosses[dungeonIndex] ={ --The Arcway
    [1] = {
        [1] = {
            ["name"] = "Ivanyr",
            ["health"] = 99914542,
...
LDT.dungeonEnemies[dungeonIndex] = { --The Arcway
    [1] = {
