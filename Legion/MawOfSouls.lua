...
local pi = math.pi
LDT.dungeonTotalCount[dungeonIndex] = {normal=150,teeming=180,teemingEnabled=true}
LDT.dungeonBosses[dungeonIndex] = {--Maw of Souls
	[1] = {
		[1] = {
...
LDT.dungeonEnemies[dungeonIndex] = { --Maw of Souls
	[1] = {
